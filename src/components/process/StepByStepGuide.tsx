  ...
  },
  {
    ...
    content: (
      <>
        ...
        <p>These banks proved to offer the most English customer support and understanding of expats needs/concerns. <p></p>Bring passport, residence card, Japanese phone number, and proof of address.</p>
      </>
    )
  },
  {
    ...
    content: (
      <>
        ...
        <p>Japanese credit card applications can be hard to pass for expats. Fill in the forms precisely. <p></p>Bring residence card, phone number, and income information.</p>
      </>
    )
  },
  {
